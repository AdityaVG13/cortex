...
function createScene({
  ...
  function frame() {
    (renderFrame(),
      (rafHandle =
        animated && !disposed ? requestAnimationFrame(frame) : null));
  }
  ...
  (controls.addEventListener("change", requestFrame),
    animated ? (rafHandle = requestAnimationFrame(frame)) : requestFrame());
  ...
  function dispose() {
    ((disposed = !0),
      rafHandle && cancelAnimationFrame(rafHandle),
      ticks.clear(),
