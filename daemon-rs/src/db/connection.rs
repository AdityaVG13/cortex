...
pub(crate) fn ensure_sqlite_vec_registered() -> Result<(), String> {
    SQLITE_VEC_REGISTRATION
        .get_or_init(|| {
            type SqliteVecEntryPoint = unsafe extern "C" fn(*mut rusqlite::ffi::sqlite3, *mut *mut std::os::raw::c_char, *const rusqlite::ffi::sqlite3_api_routines) -> std::os::raw::c_int;
            unsafe extern "C" {
