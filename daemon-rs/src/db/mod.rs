...
pub use connection::{
    configure, open, sqlite_vec_status, RepairError, RepairResult, SQLITE_BUSY_TIMEOUT_MS,
};
pub(crate) use maintenance::*;
pub use maintenance::{
    archive_entries_scoped, auto_repair, checkpoint_wal_best_effort, delete_expired_entries,
    migrate_focus_table, quick_check, rebuild_fts, rebuild_fts_if_needed, reindex_fts,
    verify_integrity,
};
pub use migrations::{
