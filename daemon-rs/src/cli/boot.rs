...
use super::common::{ensure_remote_target_has_api_key, is_local_client_base_url, local_daemon_base_url, parse_flag_usize, parse_flag_value, resolve_client_target, validate_cli_options};
...
pub(crate) fn read_auth_token_from_path(token_path: &std::path::Path) -> Option<String> {
...
pub(crate) async fn boot_agent(paths: &auth::CortexPaths, agent: &str) -> Result<(), String> {
