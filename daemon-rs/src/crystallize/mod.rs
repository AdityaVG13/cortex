            ...
            Some(crystal_id) => {
                ...
                for member in &member_entries {
                    emit_brain(
                        ...
                        json!({"cluster_id":crystal_id,"member_id":
format!("{}-{}",member.target_type,member.target_id),}),
                        owner_id,
                    );
                }
                emit_brain(
                    ...
                    json!({
"cluster_id":crystal_id,"member_count":member_entries.len()as i64,}),
                    owner_id,
                );
            ...
            None => {
                ...
                for member in &member_entries {
                    emit_brain(
                        ...
                        BrainKind::MemberAdded,
                        json!
({"cluster_id":crystal_id,"member_id":format!("{}-{}",member.target_type,member.target_id),}),
                        owner_id,
                    );
                }
                emit_brain(
                    brain,
                    BrainKind::ClusterFinalized,
                    json!({"cluster_id":crystal_id,"member_count":member_entries.len()as i64,}),
                    owner_id,
                );
