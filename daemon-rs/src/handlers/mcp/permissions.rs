...
pub(crate) fn required_permission_for_tool(tool_name: &str) -> Option<ClientPermission> {
    match tool_name {
        ...
        "cortex_store" | "cortex_agent_feedback_record" | "cortex_focus_start" | "cortex_focus_end" | "cortex_diary" => {
...
pub(crate) fn resolve_refresh_presence_agent(
    conn: &rusqlite::Connection, owner_id: Option<i64>, raw_agent: &str, model: Option<&str>, normalized_agent: &str,
...
pub(crate) async fn refresh_mcp_session_presence(
    state: &RuntimeState, caller_id: Option<i64>, raw_agent: &str, model: Option<&str>, description_prefix: &str,
