...
pub(crate) async fn upsert_mcp_session(state: &RuntimeState, caller_id: Option<i64>, raw_agent: &str, model: Option<&str>, description_prefix: &str) -> Result<(String, String), String> {
