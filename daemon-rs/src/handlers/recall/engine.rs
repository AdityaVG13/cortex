...
pub(crate) fn query_shape_profile(
    query_text: &str,
...
pub(crate) fn bm25_weights_from_resolver(
...
pub(crate) fn crystal_member_sources(
    conn: &Connection,
    crystal_id: i64,
    ctx: &RecallContext,
) -> Vec<String> {
...
pub(crate) fn query_crystal_for_unfold(
    conn: &Connection,
    crystal_id: i64,
) -> Option<CrystalUnfoldRow> {
...
pub(crate) fn apply_recall_ranking_boosts(
...
#[allow(dead_code)]
pub(crate) fn prefer_query_focused_excerpt(
    current: &str,
    candidate: &str,
    query_text: &str,
) -> bool {
