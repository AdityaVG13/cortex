...
pub fn decorate_entry_with_relation(
    entry: &mut Value,
...
pub fn has_specificity_markers(text: &str) -> bool {
    let file_extensions = [
...
#[allow(dead_code)]
pub fn fetch_top_semantic_candidates(
    _conn: &Connection,
    _query_vector: &[f32],
