...
pub fn retention_class_score(retention_class: &str) -> f64 {
...
pub fn recency_score(timestamp: Option<&str>, now: DateTime<Utc>) -> f64 {
...
pub fn activity_score(retrievals: i64, last_accessed: Option<&str>, now: DateTime<Utc>) -> f64 {
...
pub struct ContextItem {
    ...
    pub priority: f64,
    pub utility: f64,
    pub rank_audit: Option<RankAudit>,
}
impl ContextItem {
    ...
    pub fn from_ranked_candidate(candidate: RankedCandidate) -> Self {
...
pub fn attach_rank_audit(mut entry: Value, item: &ContextItem) -> Value {
...
pub struct PackedContext {
    pub assembled_parts: Vec<String>,
