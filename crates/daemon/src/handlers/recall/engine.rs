...
pub(crate) struct RecallItem {
    ...
    pub(crate) base_relevance: f64,
    pub(crate) alignment_boost: f64,
    pub(crate) entity_boost: f64,
    pub(crate) temporal_multiplier: f64,
    pub(crate) entropy_boost: f64,
    pub(crate) feedback_boost: f64,
    pub(crate) crystal_boost: f64,
    pub(crate) clock_why: Option<Value>,
    pub(crate) status: Option<String>,
    pub(crate) valid_from: Option<String>,
    pub(crate) valid_until: Option<String>,
}
impl RecallItem {
    pub(crate) fn new_with_why(source: String, relevance: f64, excerpt: String, method: String) -> Self {
        Self {
            source,
            relevance,
            excerpt,
    ...
    pub(crate) fn why_json(&self) -> serde_json::Value {
...
fn keyword_stop_words() -> &'static HashSet<&'static str> {
    ...
    STOP_WORDS.get_or_init(|| {
        [
            ...
            "may", "might", "shall", "can", "to", "of", "in", "for", "on", "with", "at", "by", "from", "as", "into", "about", "that", "this", "it", "its",
            "not", "but", "and", "or", "if", "then", "so", "what", "which", "who", "how", "when", "where", "why", "all", "each", "every", "both", "few",
            "more", "most", "some", "any", "no", "my", "your", "his", "her", "our", "their", "i", "me",
        ]
        .into_iter()
        .collect()
    })
...
#[derive(Clone, Debug)]
pub(crate) struct AsOfRecallItem {
    pub excerpt: String,
    pub source: String,
    pub relevance: f64,
    pub method: String,
...
pub(crate) fn normalize_as_of_timestamp(raw: &str) -> Result<String, String> {
...
pub(crate) fn run_as_of_recall(conn: &Connection, query_text: &str, as_of: &str, k: usize, ctx: &RecallContext) -> Result<Vec<AsOfRecallItem>, String> {
