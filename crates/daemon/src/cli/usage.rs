...
"Cortex agent capabilities\n\
         ...
         Core JSON commands: status --json, paths --json, boot --json, reindex --json, recrystallize --json, rebuild-anchors --json, admin budgets status --json\n\
...
fn top_level_command_suggestion(command: &str) -> Option<&'static str> {
    ...
    match normalized.as_str() {
        ...
        "rebuildanchors" | "rebuildanchor" | "reembed" | "reembeddings" => Some("cortex rebuild-anchors --json"),
        _ => None,
    }
}
