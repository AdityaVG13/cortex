...
pub(crate) fn prune_crystal_member_embeddings(_conn: &Connection) -> usize {
    0
}

pub(crate) fn prune_orphan_cluster_members(conn: &Connection, failures: &mut Vec<MaintenanceFailure>) -> usize {
