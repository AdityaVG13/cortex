...
use cortex_daemon::cli::{
    ...
    run_admin_cli, run_backup_cli, run_boot_cli, run_cleanup_cli, run_doctor_cli, run_embeddings_cli, run_eval_cli, run_export_cli, run_import_cli,
    run_rebuild_anchors_cli, run_recrystallize_cli, run_reindex_cli, run_restore_cli, run_status_cli, run_sync_cli, run_team_cli, run_user_cli,
    ...
    match mode {
        ...
        "serve" => {
            ...
            run_daemon(paths.clone(), async {
                tokio::select! {_=tokio::signal::ctrl_c()=>eprintln!(
        ...
        "rebuild-anchors" => {
            run_rebuild_anchors_cli(&paths, &args[2..]).await;
        }
