...
pub use common::{
    apply_path_env, ensure_remote_target_has_api_key, parse_flag_usize, parse_flag_value, resolve_client_target, validate_cli_options_or_exit,
};
pub use daemon::{ensure_daemon, is_disallowed_startup_binary_path, run_daemon};
pub use doctor::run_doctor_cli;
pub use embeddings::{run_embeddings_cli, run_embeddings_drain_cli};
pub use eval::run_eval_cli;
pub use reindex::{run_recrystallize_cli, run_reindex_cli};
pub use status::run_status_cli;
pub use sync::{run_export_cli, run_import_cli, run_sync_cli};
pub use usage::{
